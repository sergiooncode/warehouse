...
from src.domain.model.repository.article_inventory_reader_repository import ArticleInventoryReaderRepository
from src.infrastructure.persistence.mongoengine.model.article_inventory import MongoArticleInventory
...
class MongoengineArticleInventoryReaderRepository(ArticleInventoryReaderRepository):
    def detail_inventory_by_id(self, article_id: str) -> ArticleInventory:
        article_inventory_object = MongoArticleInventory.objects(article_id=article_id).all()[0]
